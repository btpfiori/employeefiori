		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comemployeeapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comemployeeapp-display": {
								"semanticObject": "comemployeeapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.employeeapp",
									"url": sap.ui.require.toUrl("com/employeeapp")
								}
							}
						}
					}
